...
import static nosdaq.synth.EnumSynthesizer.updateProductionMap;
import static nosdaq.trans.MongoDBTranslator.translate;
import static org.junit.jupiter.api.Assertions.*;

class EnumSynthesizerTest2 {
    private Schema buildSchema() {
        List<AttrSchema> attrSchemas = new ArrayList<>();
        AttrSchema id = new AttrSchema(new AccessPath(null, new Attribute("_id")), INT);
        AttrSchema name = new AttrSchema(new AccessPath(new AccessPath(new AccessPath(null, new Attribute("origin")), new Attribute("area")), new Attribute("country")), STRING);
        AttrSchema type = new AttrSchema(new AccessPath(null, new Attribute("fruitType")), ARRAY);
        attrSchemas.add(id);
        attrSchemas.add(name);
        attrSchemas.add(type);
        Schema schema = new Schema("fruit", attrSchemas);
        return schema;
    }

    @Disabled
    @Test
    void testGenerateTree() throws IOException {
        ...
        Document document1 = new Document("_id", "645d1c47e7bc6975168e2f7f")
                .append("name", "apple")
                .append("type", List.of("Granny smith", "Fuji"));
        inputs.add(document1);

        Document document2 = new Document("_id", "645d1c47e7bc6975168e2f80")
                .append("name", "grape")
                .append("type", List.of("green", "black"));
        inputs.add(document2);

        Document document3 = new Document("_id", "645d1c47e7bc6975168e2f81")
                .append("name", "orange")
                .append("type", List.of("navel"));
        inputs.add(document3);

        // Add the documents to the output list
        List<Document> outputs = new ArrayList<>();
        Document document4 = new Document("name", "apple");
        outputs.add(document4);

        Document document5 = new Document("name", "grape");
        outputs.add(document5);

        Example example = new Example(inputs, outputs);
        List<Example> examples = new ArrayList<>();
        examples.add(example);

        Program result = synthesizer.synthesize(grammar, schema, examples, 10);
    }


    @Disabled
    @Test
    void testAstToProgram() {
        TreeNode treeNode = new TreeNode(new NonTerminal("find"));
        treeNode.addChild(new TreeNode(new Terminal("true")));
        treeNode.addChild(new TreeNode(new Terminal("empty")));

        Program program = Parser.parseProgram(treeNode);
        Assertions.assertEquals(("db.collection.find({ })").replaceAll("\\s", ""),
                translate(program).replaceAll("\\s", ""));
    }


    @Disabled
    @Test
    void testUpdateproductionMap() throws IOException {
        Schema schema = buildSchema();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar.txt");
        Map<NonTerminal, List<Production>> productionMap = grammar.getLhsToProductionMap();
        productionMap = updateProductionMap(productionMap, schema);
        NonTerminal nonTerminal = new NonTerminal("CE");

        List<Production> productionsRules = productionMap.get(nonTerminal);
    ...
    void test1EnumSynthesizer2() throws IOException { // Success
        Synthesizer synthesizer = new EnumSynthesizer2();
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test2EnumSynthesizer2() throws IOException { // Success if we reduce grammar size
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test3EnumSynthesizer2() throws IOException, ParseException { // Success if we reduce grammar size
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test5EnumSynthesizer2() throws IOException, ParseException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test6EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
        ...
        BenchmarkLoader.printExamples(examples);
...
//        Assertions.assertNotEquals(0, file.length());
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test7EnumSynthesizer2() throws IOException, ParseException { // benchmark #7 OOM
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test8EnumSynthesizer2() throws IOException { // Success
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test9EnumSynthesizer2() throws IOException { // Found db.test9.aggregate([{$match: {"pictures" : {$ne: []}}}]);
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test11EnumSynthesizer2() throws IOException, ParseException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test12EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test13EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test14EnumSynthesizer2() throws IOException { // Timeout
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test15EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test16EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test17EnumSynthesizer2() throws IOException, ParseException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test18EnumSynthesizer2() throws IOException, ParseException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test19EnumSynthesizer2() throws IOException, ParseException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test20EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test21EnumSynthesizer2() throws IOException { // Success
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test23EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test24EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test43EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test51EnumSynthesizer2() throws IOException { // Fail
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test27EnumSynthesizer2() throws IOException, ParseException{ // No new Date() in grammar
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test28EnumSynthesizer2() throws IOException { // Found db.collection.aggregate([{$match:{"ln": { $exists: true }}}])
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test32EnumSynthesizer2() throws IOException {
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test41EnumSynthesizer2() throws IOException { // Found db.collection.aggregate([{$match: {"post": {$ne: ""}}}]);
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
    ...
    @Test
    @Timeout(value = 5, unit = TimeUnit.MINUTES)
    void test50EnumSynthesizer2() throws IOException { // New attribute "count" in outputs
        Synthesizer synthesizer = new EnumSynthesizer2();
        Grammar grammar = GrammarParser.parse("./src/main/java/nosdaq/grammar/Grammar2.txt");
