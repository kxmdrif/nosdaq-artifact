...
from semantics import semantic_doc
...
def sexp_to_value(sexp):
    ...
    if value_type.type_code == exprtypes.TypeCodes.integer_type:
        ...
        value = value_exp
    elif value_type.type_code == exprtypes.TypeCodes.doc_type:
        value = value_exp
    else:
...
_known_theories = ["LIA", "BV", "SLIA", "Doc"]
...
def get_theory_instantiator(theory):
    if theory == "LIA":
        ...
        return semantic_doc.DOCInstantiator()
    else:
